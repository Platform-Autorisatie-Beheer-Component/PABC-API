...
| settings.keycloakAdmin.clientId | string | `""` | Client ID for accessing Keycloak Admin API. <details> <summary>More information</summary> For example: `admin-cli` </details> |
