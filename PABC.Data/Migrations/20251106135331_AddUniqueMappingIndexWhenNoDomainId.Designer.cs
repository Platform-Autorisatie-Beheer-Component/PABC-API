...
namespace PABC.Data.Migrations
{
    ...
    [Migration("20251106135331_AddUniqueMappingIndexWhenNoDomainId")]
    partial class AddUniqueMappingIndexWhenNoDomainId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PABC.Data.Entities.Application", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PABC.Data.Entities.Mapping", b =>
                {
                    ...
                    b.HasIndex("ApplicationRoleId", "FunctionalRoleId")
                        .IsUnique()
                        .HasDatabaseName("ix_mapping_application_role_id_functional_role_id")
                        .HasFilter("\"domain_id\" IS NULL");
                    ...
                    b.HasIndex("ApplicationRoleId", "DomainId", "FunctionalRoleId")
                        ...
                        .HasFilter("\"domain_id\" IS NOT NULL");

                    b.ToTable("mapping", null, t =>
                        {
                            t.HasCheckConstraint("CK_Mapping_domain_id_is_all_entity_types", "\"is_all_entity_types\" = false OR \"domain_id\" IS NULL");
                        });
                });
